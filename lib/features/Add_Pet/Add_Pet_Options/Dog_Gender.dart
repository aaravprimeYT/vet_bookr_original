...
class DogGenderSelection extends StatefulWidget {
  const DogGenderSelection({super.key});

  @override
  State<DogGenderSelection> createState() => _DogGenderSelectionState();
}

class _DogGenderSelectionState extends State<DogGenderSelection> {
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.only(right: 0.55.sw),
              child: Text(
                "Is your dog a ",
                style: TextStyle(
                  fontSize: 25.sp,
