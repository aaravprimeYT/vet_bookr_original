...
class PetParkController {
  ...
  Future<void> getTotalData() async {
    ...
    String vetsUrl =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=pet+parks&location=${latLng[0]},${latLng[1]}&radius=$apiChanger&type=pet-parks&key=${Constants
        .apiKey}";
