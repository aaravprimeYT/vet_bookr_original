...
class _PetCafesPageState extends State<PetCafesPage> {
  ...
  Future<void> getTotalData() async {
    ...
    String vetsUrl =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=pet+cafe&location=${latLng[0]},${latLng[1]}&radius=2500&type=pet_cafe&key=${Constants.apiKey}";
