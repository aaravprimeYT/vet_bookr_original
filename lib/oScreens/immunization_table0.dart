...
class ImmunizationTable0 extends StatelessWidget {
  const ImmunizationTable0({Key? key}) : super(key: key);
            ...
            child: Table(
             ...
             // defaultColumnWidth: FixedColumnWidth(100),
              border: TableBorder.all(
                  color: const Color(0xffFF8B6A), style: BorderStyle.solid, width: 2),
              children: [
                TableRow(children: [
                  TableCell(
              ...
              TableRow(children: [
                  ...
                  //   TextFormField(
                  //     style: const TextStyle(
                  //         backgroundColor: Color(0xffFAEDE1), fontSize: 15.0),
                  //   )
                  // ]),
                ]),
                TableRow(children: [
