...
class _PetTrainersPageState extends State<PetTrainersPage> {
  ...
  Future<void> getTotalData() async {
    ...
    String vetsUrl =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=pet+trainers&location=${latLng[0]},${latLng[1]}&radius=2500&type=pet_trainers&key=${Constants.apiKey}";
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: Colors.deepOrange[300], fontSize: 22.sp),
                ),
              ),
              Divider(
                thickness: 2,
